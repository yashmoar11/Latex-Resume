  ...
  \cventry
    ...
    {August 2022 - July 2025} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        % systems.}
        \item {Versatile Address Component: Created \textbf{5+ Higher Order Components} (HOCs) in React to build a flexible address component adaptable
        ...
        duplicity by 35\% and ensuring zero critical or major issues in production.}
