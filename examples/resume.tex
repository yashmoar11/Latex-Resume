...
\name{Jai}{Shah}
\position{Software Engineer | Graduate Student} % {\enskip\cdotp\enskip}Software Architect
% \address{235, World Cup buk-ro, Mapo-gu, Seoul, 03936, Republic of Korea}

\mobile{+1 (323) 334-7408}
\email{jaijayes@usc.edu}
%\dateofbirth{January 1st, 1970}
% \homepage{www.posquit0.com}
% \github{yashmoar11}
\linkedin{jaishah9} %linkedin.com/in/yash-moar
% \gitlab{gitlab-id}
