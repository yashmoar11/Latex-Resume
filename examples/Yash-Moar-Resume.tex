...
\geometry{left=1.4cm, top=.4cm, right=1.4cm, bottom=0.4cm, footskip=.1cm}
...
\name{Yash}{Moar}
\position{M.S. specializing in Machine Learning Systems \enskip\cdotp\enskip Former Software Engineer at HSBC} % {\enskip\cdotp\enskip}Software Architect
% \address{235, World Cup buk-ro, Mapo-gu, Seoul, 03936, Republic of Korea}

\mobile{(+1) 540-824-9514}
\email{yashmoar11@gmail.com}
%\dateofbirth{January 1st, 1970}
% \homepage{www.posquit0.com}
\github{yashmoar11}
\linkedin{yash-moar} %linkedin.com/in/yash-moar
% \gitlab{gitlab-id}
